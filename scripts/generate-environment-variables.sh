...
echo "NEXT_PUBLIC_MICRO_SERVICE_PORT_AUTH=$MICRO_SERVICE_PORT_AUTH" >> environment-variables/micro-front-end-auth.env
...
echo "NEXT_PUBLIC_MICRO_SERVICE_PORT_SYSTEM=$MICRO_SERVICE_PORT_SYSTEM" >> environment-variables/micro-front-end-system.env
...
echo "NEXT_TELEMETRY_DISABLED=1" >> environment-variables/npm-micro-front-end-system.env
