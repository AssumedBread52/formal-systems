...
export class AddSymbolsTable0000000000004 extends BaseMigration {
  public readonly UP_SCRIPT = `
    CREATE TABLE symbols (
      ...
      CONSTRAINT symbols_system_id_name_unique  UNIQUE(system_id, name),
      CONSTRAINT symbols_system_id_id_unique    UNIQUE(system_id, id)
    );
  `;

  public readonly DOWN_SCRIPT = 'DROP TABLE symbols;';
};
