...
export class UserResolver {
  ...
  public createUser(@Args('userPayload') newUserPayload: NewUserPayload, @Context('res') response: Response): Promise<UserEntity> {
  ...
  public users(@Args('filters') searchUsersPayload: SearchUsersPayload): Promise<PaginatedUsersPayload> {
